...
1. Download and install the toolbox from the releases page (https://github.com/ptoshkov/integratedterminal/releases), the MATLAB Central (https://uk.mathworks.com/matlabcentral/fileexchange/183584-integrated-terminal) or the Add-On Explorer inside the MATLAB IDE.
